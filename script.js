...
const HTMLFullMonthYearDate = `<article class="center_article">
<hgroup>
...
<article class="center_article" id="monthList">
...
const HTMLMonthDate = `        <article class="center_article">
<hgroup>
    <h1><span id="updateHeading"></span></h1>
    <p><span id="updateDescription"></span></p>
</hgroup>
...
<article class="center_article" id="monthTable">
...
function handleYearDate(year, currentTime) {
  ...
  for (let i = 0; i < 12; i++) {
    ...
    descYears = `${firstYearDiff} or ${lastYearDiff} years`;
